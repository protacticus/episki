...
class AddUserCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $fullName = $input->getArgument('full-name');
        $isAdmin = true; // temporary because we only have one role
        ...
        $this->io->success(sprintf('The user was successfully created: %s (%d) %s', $user->getEmail(), $user->getId(), $isAdmin ? 'Administrator user' : 'Normal user'));
